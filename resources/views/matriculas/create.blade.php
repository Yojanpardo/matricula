		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input id="depa_expedicion" class="form-control col-md-7 col-xs-12" type="text" name="depa_expedicion">
					</div>
				</div>
				<div class="form-group">
					<label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Municipio de Expedición</label>
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input id="muni_expedicion" class="form-control col-md-7 col-xs-12" type="text" name="muni_expedicion">
					</div>
				</div>
				<div class="form-group">

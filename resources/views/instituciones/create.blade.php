...
<script type="text/javascript">
	...
	function simple3(){	
		...
		var marker = createMarker(point,'<div style="width:240px">'+point+' <\/div>')
...
@section('pagina', 'Creación de Institucion')
...
<div class="row">
	<div class="col-md-6 col-sm-6 col-xs-6">
		<div class="x_panel">
			...
			<div class="x_content">
				<br />
				{!! Form::open(['route' => 'instituciones.store', 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal form-label-left']) !!}
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						{!! Form::select('rector', $rectores, null, ['class' => 'form-control', 'required', 'placeholder' => 'Seleccione Rector', 'id' => 'rector', 'name' => 'rector', 'required']) !!}
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input type="text" id="latitud" readonly="" name="latitud" required="required" class="form-control col-md-7 col-xs-12">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input type="text" id="longitud" readonly="" name="longitud" required="required" class="form-control col-md-7 col-xs-12">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12" >
						{!! Form::select('cursos[]', $cursos, null, ['class' => 'form-control', 'required', 'id' => 'cursos', 'required', 'multiple', 'data-placeholder' => 'Seleccione curso y jornada']) !!}
					</div>
				</div>
